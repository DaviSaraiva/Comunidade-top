                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div id='formvip'  style="margin-top:10px;">
                        ...
                        <form action='' id='emailvip' method="post" name="emailvip">
                            ...
                            <button  type="button" class=" btn btn-secondary btn-lg " id='listavip'  style="margin-top:15px;">
                                Inscreva-se aqui
                            </button>
                        </form>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div style="background-color: black; margin-left: 10px;margin-right: 10px;;margin-top: 10px;" id="formVipIndex">
                            ...
                            <center>
                                <span style="color: white; font-family: Arial;font-size: 20px;">Participação Obrigatória para quem<br>
                                    quer lapidar seu negócio diariamente!</span><br><br>
                            </center>
                            
                            <center>
                                <img src="img/te.jpg"  width="100" height="100"  style="margin-top:8px;"><br>
                            </center>
                            
                            <center> 
                                <button type="button" class="btn btn-secondary btn-lg " style="background-color: yellow;margin-top: 30px; border-radius: 2rem; ">
                                    <span style="color:black;">Quero Participar</span>
                                </button>
